...
from datasets.bottle import BOTTLE, BOTTLEANO
...
from classes import BOTTLE_TO_BOTTLE
...
SETTINGS = {'visa_to_mvtec': VISA_TO_MVTEC, 'mvtec_to_visa': MVTEC_TO_VISA,
            ...
            'screw_to_screw':SCREW_TO_SCREW,'capsule_to_capsule': CAPSULE_TO_CAPSULE,'bottle_to_bottle':BOTTLE_TO_BOTTLE}
